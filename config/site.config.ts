...
export const siteConfig: SiteConfig = {
  ...
  contactForm: {
    path: "",
    fields: [
      // { label: "Name", value: "Test User", required: true },
      // { label: "Email", value: "test@example.com", required: true },
      // { label: "Message", value: "This is an automated test message.", required: true },
    ],
